...
CREATE TABLE `ucar_order` (
  `order_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `order_name` varchar(50) NOT NULL COMMENT '订单名',
  `recommend_mobile` varchar(50) DEFAULT NULL COMMENT '推荐人号码',
  `apply_mobile` varchar(50) DEFAULT NULL COMMENT '申请人号码',
...
) ENGINE=InnoDB AUTO_INCREMENT=100000 DEFAULT CHARSET=utf8 COMMENT='订单信息';